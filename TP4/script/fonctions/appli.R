...
legend(0.7, 0.4, legend=c(paste(c("ADL (",round(auc_adl,digits=3),")"), collapse='') , paste(c("ADQ (" ,round(auc_adq,digits=3),")"), collapse=''), paste(c("NBA (" ,round(auc_nba, digits=3),")"), collapse=''), paste(c("LOG (" ,round(auc_log,digits=3),")"), collapse='')),
